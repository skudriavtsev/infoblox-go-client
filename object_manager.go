...
type IBObjectManager interface {
	...
	CreateMXRecord(dnsView string, fqdn string, mx string, priority uint32, ttl uint32, useTtl bool, comment string, eas EA) (*RecordMX, error)
	...
	GetSRVRecord(dnsView string, name string, priority uint32, weight uint32) (*RecordSRV, error)
	...
	UpdateMXRecord(ref string, dnsView string, fqdn string, mx string, ttl uint32, useTtl bool, comment string, priority uint32, eas EA) (*RecordMX, error)
